      ...
      <main className="icd-cases">
        ...
        <section className="icd-cases__hero">
          <div className="icd-cases__hero-copy">
            <div className="icd-cases__hero-main">
              <p className="icd-cases__kicker">设计参考入口</p>
              <h1>设计资源库</h1>
              <p className="icd-cases__sub">
                整理团队常用的设计网站与参考资源，按用途筛选，快速打开灵感、案例和工具。
              </p>
            </div>
            <div className="icd-cases__stats">
              <span data-label="个资源">{String(stats.total).padStart(2, '0')}</span>
        ...
        {/* 案例卡片网格 */}
        {filtered.length > 0 ? (
          <section className="icd-cases__grid" aria-label="设计资源列表">
            {filtered.map((item) => (
