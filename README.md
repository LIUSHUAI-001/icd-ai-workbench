...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v2.2.3
>
...
![status](https://img.shields.io/badge/version-v2.2.3-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
- 🏷️ **v2.2.3 GitHub 源码版**：继续完善动漫标签大师 Danbooru / Gelbooru 在线图库，修复在线热门排序被前端名称排序覆盖、分类搜索串回画师、回车搜索、分页返回、预览重试、占位图和紧凑 UI 细节；本次只推 GitHub 源码，不打包 Electron，不发布 GitHub Release / `latest.yml`
