...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v2.2.2
>
...
![status](https://img.shields.io/badge/version-v2.2.2-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
- 🚀 **v2.2.2 Electron 自动更新版**：RH 工具箱正式内置 5 个 RunningHub AI 应用，打包前校验发布 manifest，打包后确认前端产物包含真实工具标记，前端 `__APP_VERSION__` 与桌面端同步为 2.2.2，并继续收口艺术风格大师、动漫标签大师、资源库分类、图像裁切、任务提示音、Codex / 生图工作台和俄罗斯方块主题细节
