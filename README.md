...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v1.6.2
>
...
![status](https://img.shields.io/badge/version-v1.6.2-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
- 🚚 **跨画布素材发送 + Eagle 本地入库**：框选上传素材、输出素材或素材集后可发送到其他画布，支持智能保持 / 合并素材集 / 上传素材 / 拆分上传 / 输出素材；发送后可自动切换并定位到新节点，同批素材重复发送会替换旧批次，资源库素材也可一键发送，Eagle 入库仅允许本机 localhost 接口
...
- 🌗 **主题模板系统**：科技风 / 像素糖果风 / OP 风格 / RH 风格 / 火影忍者风格 / EVA 风格六套内置模板，支持浅色 / 深色、导入导出、编辑保存、自定义路径与默认静音主题音乐
