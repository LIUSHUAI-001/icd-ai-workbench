...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v1.4.8
>
...
![status](https://img.shields.io/badge/version-v1.4.8-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
- ✂️ **宫格剪裁去缝预览**：独立宫格剪裁节点支持 gap 去缝、常用宫格预设、指定序号导出、输出顺序和上游合集批量拆分，并在节点内直接预览切线与被裁掉的缝隙区域
- 🎬 **电影感组合器**：电影感节点支持 15 个成片风格、镜头 / 光影 / 调色 / 质感各 15 项、中英文 prompt、强度和自定义补充；可手动连到下游，也可一键运行输出到 OutputNode
- 🎥 **视频运镜组合器**：视频运镜节点支持成片场景、运镜动作、路径、节奏、稳定和主体约束组合，带路线示意、中英文 prompt 和一键运行输出
...
产物：`dist_electron/T8-PenguinCanvas-Setup-<version>.exe`（v1.4.8 打包后以实际产物大小为准）
